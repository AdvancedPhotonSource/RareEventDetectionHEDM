...
baselinePATH=/home/wzheng/EventDetection/sangid_patch_dir_case1/
baselineNAME=lshr_r1e_state_2_bigbox_ff_000503.h5
...
model_dstNAME=lshr_503_emb
exp_name=lshr

model_dstPATH=/home/wzheng/EventDetection/modelTrained/
model_dstNAME=lshr_503_emb64.pth

# event detection related parameters and paths
thresholds=$(seq 0.2 0.1 0.7)
numcenters=$(seq 30 10 60)

eva_datasetPATH=/home/wzheng/EventDetection/sangid_patch_dir_case1/
eva_wrkPATH=/home/wzheng/EventDetection/rareEventHEDM_v1/
eva_resultPATH=/home/wzheng/EventDetection/rareEventHEDM_v1/case1/
