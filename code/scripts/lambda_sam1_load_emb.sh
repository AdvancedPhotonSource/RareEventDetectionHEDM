...
# this script is for using the embedding model trained on park 22 to test on sam1
...
eva_resultPATH=/homes/wzheng/EventDetection/rareEventHEDM_v1/sam1_test_pretrained/
