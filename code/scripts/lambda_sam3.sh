...
baselinePATH=/homes/wzheng/kasemer_mar22_patches/kasemer_sam3_patch_dir/
baselineNAME=sam3_ff_0N_000247.edf.h5
...
model_dstNAME=sam3_ff_000247-d

# event detection related parameters and paths
thresholds=$(seq 0.3 0.05 0.35)
numcenters=$(seq 25 5 30)

eva_datasetPATH=/homes/wzheng/kasemer_mar22_patches/kasemer_sam3_patch_dir/
eva_wrkPATH=/homes/wzheng/EventDetection/rareEventHEDM_v1/
eva_resultPATH=/homes/wzheng/EventDetection/rareEventHEDM_v1/sam3_test/
...
do
  cd $train_wrkPath
  python main.py -expName $exp_name -ih5 $baselinePATH$baselineNAME -zdim $i -gpus 5
