...
baselinePATH=/homes/wzheng/EventDetection/beamsize_400_patches/
baselineNAME=park_ss_ff_0MPa_000315.edf.h5
train_wrkPath=/homes/wzheng/BraggEmb/
exp_name=park_ss_ff

model_dstPATH=/homes/wzheng/EventDetection/modelTrained/
model_dstNAME=park_315-318.pth

# event detection related parameters and paths
thresholds=$(seq 0.3 0.05 0.3)
numcenters=$(seq 25 5 25)

eva_datasetPATH=/homes/wzheng/EventDetection/beamsize_400_patches/
eva_wrkPATH=/homes/wzheng/EventDetection/rareEventHEDM_v1/
eva_resultPATH=/homes/wzheng/EventDetection/rareEventHEDM_v1/beamsize_test_315_318/
...
do
  ...
  do
    ...
    do
      ...
      -dpre $exp_name\
      -degs 360 > deg360_315-318_beamsize.log &
    done
  done 
done
